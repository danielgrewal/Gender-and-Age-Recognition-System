...
path = os.path.join(CURRENT_DIR, "gender_classification_model.pth")
AGE_MODEL_PATH = os.path.join(CURRENT_DIR, "age_regression_model.pth")
GENDER_MODEL_PATH = os.path.join(CURRENT_DIR, "gender_classification_model.pth")
